...
define MYSQL_CLIENT_COPY_MYSQL_CONFIG
	cp $(MYSQL_CLIENT_DIR)/scripts/mysql_config $(STAGING_DIR)/usr/bin
endef
...
MYSQL_CLIENT_POST_INSTALL_TARGET_HOOKS += MYSQL_CLIENT_COPY_MYSQL_CONFIG
